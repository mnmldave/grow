  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "ProductionDelimiter": parse_ProductionDelimiter,
      ...
      function parse_ProductionList() {
        ...
        if (result2 !== null) {
          ...
          if (result3 !== null) {
            var result4 = [];
            var savedPos1 = pos;
            var result6 = parse_ProductionDelimiter();
            if (result6 !== null) {
              var result7 = parse__();
              if (result7 !== null) {
      ...
      function parse_ProductionDelimiter() {
        var cacheKey = 'ProductionDelimiter@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
